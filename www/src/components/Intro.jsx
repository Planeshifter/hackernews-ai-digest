  ...
  return (
    <>
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        <IconLink href="https://github.com/Planeshifter/hackernews-ai-digest" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink href="https://twitter.com/burckhap" icon={TwitterIcon} compact large>
        Philipp Burckhardt
      </IconLink>
    </p>
  )
