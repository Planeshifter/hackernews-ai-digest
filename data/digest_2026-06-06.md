...
Here is a daily digest summary of the Hacker News discussion surrounding **"sem" (Semantic Git)**:

### 🗞️ Hacker News Daily Digest: "sem" brings semantic diffs to Git

**The Pitch:** 
Developers are discussing a new CLI tool called **"sem"** by Ataraxy Labs, which layers semantic understanding on top of Git. Instead of showing changes line-by-line, it tracks modifications by functions, classes, and types across 26 languages using Structural AST (Abstract Syntax Tree) parsing. It claims to dramatically improve code reviews, refactoring blast-radius analysis, and AI agent prompt accuracy. 
...
Here is your daily digest summarizing the Hacker News discussion surrounding the Meta/Instagram AI chatbot vulnerability. 

***

# Hacker News Daily Digest: Meta's AI Chatbot Blunder

**The Backdrop:** Meta recently disclosed that over 20,225 Instagram accounts were hijacked due to a flaw in an AI-assisted account recovery chatbot. The bot allowed attackers to send password reset links to emails they controlled—bypassing email-matching checks entirely—as long as the target lacked 2FA. 
