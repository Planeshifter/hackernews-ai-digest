...
Here is a daily digest summarizing the Hacker News discussion surrounding the AI-assisted breakthrough on the Erdős problem:

**The Breakthrough: AI and an Amateur Crack a 60-Year-Old Erdős Math Problem** 
In a fascinating fusion of human prompting and artificial intelligence, Liam Price, a 23-year-old without formal advanced math training, used ChatGPT Pro (GPT-5.4) to solve a stubborn Erdős conjecture regarding "primitive sets." By instructing the model to avoid internet searches and synthesize non-trivial proofs, the AI discovered a novel route—leveraging a known formula from a related area that human mathematicians had historically overlooked. Top mathematicians Terence Tao and Jared Lichtman validated and polished the AI's messy but genuinely insightful draft, proving the conjecture.
...
#### [Submission URL](https://blog.matthewbrunelle.com/its-ok-to-use-coding-assistance-tools-to-revive-the-projects-you-never-were-going-to-finish/) | 319 points | by [speckx](https://news.ycombinator.com/user?id=speckx) | [203 comments](https://news.ycombinator.com/item?id=47902525)
...
DeepSeek‑V4 on Day 0: SGLang + Miles ship open-source inference and RL training for a 1M‑context, hybrid‑attention model
...
Here is your daily digest summarizing the Hacker News discussion surrounding **LamBench v1**:

***

# 🗞️ Hacker News Daily Digest: LamBench v1

**The Context:** Victor Taelin (creator of HVM and Bend) released LamBench, a new benchmarking suite designed to measure the "intelligence, speed, and elegance" of languages, runtimes, and (increasingly) AI models. By testing systems on a matrix of small, purely algorithmic problems, the benchmark aims to test how well compilers or AI models handle high-level logic without relying on benchmark-cheating tricks. 

**The Conversation:** The HN discussion split into two distinct camps. Half the community engaged in a fierce debate over LLM capabilities and the hype surrounding open-weights models, while the other half gecked out over the highly technical implications of pure lambda calculus and parallel computing. 
...
Here is a daily digest-style summary of the Hacker News discussion surrounding **Stash**:

***

# 🗞️ Hacker News Daily Digest: Ending "AI Amnesia" or Just Fancy RAG? 

**The Pitch:**
Today’s top story focuses on **Stash**, an open-source “second brain” designed to give AI agents long-term, persistent memory. Built on PostgreSQL and pgvector, it aims to replace standard, stateless RAG (Retrieval-Augmented Generation) with a system that proactively tracks goals, learns from failures, and organizes knowledge into hierarchical namespaces. It promises to let Claude, GPT, or local models remember you and your projects indefinitely.
