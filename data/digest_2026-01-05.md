...
#### [Submission URL](https://gwern.net/doc/science/2025-kusumegi.pdf) | 56 points | by [nkko](https://news.ycombinator.com/user?id=nkko) | [18 comments](https://news.ycombinator.com/item?id=46505296)

I can’t read this because it’s a raw PDF stream (binary data). Please share one of the following so I can write an engaging HN-style summary:
- The HN post or article/PDF URL
- The title plus the abstract or main text pasted as plain text
- Key sections (intro, findings, conclusion)

If you’re in a hurry, a one‑line description of what it’s about is enough for me to draft a concise daily-digest summary.

Here is a daily digest style summary of the discussion.

**Topic:** [Is the signal-to-noise ratio in scientific papers crashing?]
**Submission:** A new paper argues that the relationship between writing complexity and research quality has reversed in the post-LLM era. Previously, sophisticated language correlated with higher status and effort; now, complex and polished manuscripts often mask "substantively weaker scientific contribution." The authors claim LLM adoption resulted in a productivity shock (output up ~89%) that is flooding the zone with "looks-like-science," driving the peer review signal to near zero.

**The Discussion:**
Commenters discussed the collapse of trusted signals in academic publishing and where scientific verification goes next.

*   **The "Polished Turd" Era:** Users largely validated the paper's thesis, noting that LLMs allow creating "looks-like-science" at industrial scale. There is a fear that without changes to "publish or perish" incentives, "robot-wielding bullshitters" will crowd out genuine researchers in a race to the bottom.
*   **Trust vs. Verification:** **DoctorOetker** suggested a pivot toward formal verification, where putative proofs are machine-checked or experimental measurements are cryptographically signed by the equipment (e.g., oscilloscopes) to prevent faked data, moving trust away from the text itself.
*   **De-scaling Science:** **lo_zamoyski** and others predict a move toward decentralization. As broad broadcasting (journals) becomes worthless due to noise, researchers may return to small, high-trust networks where reports are shared directly among colleagues.
*   **The "Science Twitter" Vacuum:** **hrnj** lamented the decline of Science Twitter, noting that LinkedIn is a poor replacement for discovering genuine work versus career advertising. There is a desire for arXiv to integrate social/review layers (an overlay branding system) to replace traditional journals.
*   **Meta-Commentary:** Users noted the irony of having valid research obscured by the very tools (LLMs) used to analyze them. **brshnmzv** pointed out that Paul Ginsparg (founder of arXiv) is a co-author of the study, lending weight to the data collection method which scraped huge portions of arXiv and SSRN.
...
#### [Submission URL](https://support.microsoft.com/en-us/office/the-microsoft-365-app-transition-to-the-microsoft-365-copilot-app-22eac811-08d6-4df3-92dd-77f193e354a5) | 22 points | by [altern8](https://news.ycombinator.com/user?id=altern8) | [3 comments](https://news.ycombinator.com/item?id=46505483)

Microsoft renames the Office app to “Microsoft 365 Copilot,” moves to new domain

- What’s new: The Microsoft 365 (formerly “Office”) app is now called Microsoft 365 Copilot across web, mobile, and Windows. Rollout began Jan 15, 2025. The primary URL is now m365.cloud.microsoft; office.com and microsoft365.com redirect there.

- Copilot access:
  - Work/school: Copilot Chat is available at no extra cost to users with a Microsoft 365 license, and to those with a Microsoft 365 Copilot license.
  - Personal: Copilot Chat in the Microsoft 365 Copilot app is available to Microsoft 365 Personal, Family, and Premium subscribers (primary account holders only). No access for non‑subscribers.
  - Regions without Copilot: The Copilot tab is hidden, but the app keeps the new name/icon.

- App vs app: 
  - Microsoft 365 Copilot app is the productivity hub (files, Word, Excel, PowerPoint, PDFs, scanning, and Copilot features) and supports both Entra (work/school) and personal Microsoft accounts.
  - The standalone Microsoft Copilot app is the general AI chat companion and only supports personal Microsoft accounts.

- If you don’t see the change: Connect to the internet and restart the app.

Why it matters: Microsoft is cementing “Copilot” as the front door to Microsoft 365, bundling Chat for many org users and aligning branding under the cloud.microsoft domain—another step in its AI‑first productivity push.

**HN Discussion:**
The discussion provided is brief and focuses on the submission itself rather than the content of the article. Users pointed out that this news had been discussed previously, with one commenter characterizing the post as "ragebait." The submitter acknowledged missing the earlier news cycles, observing that articles critical of Microsoft (referencing the "Microslop" meme) tend to reliably generate engagement.
