...
Program of Thoughts Prompting: letting the LLM write code, and a computer do the math
...
#### [Submission URL](https://thinkinggamefilm.com) | 202 points | by [ChrisArchitect](https://news.ycombinator.com/user?id=ChrisArchitect) | [133 comments](https://news.ycombinator.com/item?id=46097773)

The linked “story” appears to be just a newsletter sign-up form—“Email Address — Sign Up — We respect your privacy. Thank you!”—with no article content. It’s likely a mislinked URL or content gated behind a signup. If there’s an alternate or archived link with the actual write-up, share it and I’ll update the digest.

**Scientific Value vs. Entertainment**
The discussion opens with users debating the utility of generative AI. While the initial commenter dismisses AI video and image generation as a "complete waste," others argue these are merely "sideshows" compared to the technology's real value in hard sciences. Specific examples of high-value applications cited include **AlphaFold (biology)**, **materials science**, and **weather prediction**.
*   **Monetization:** Participants note a discrepancy between scientific value and commercial success. Some argue that scientific AI (like Isomorphic Labs) must vertically integrate (e.g., actually developing the drugs rather than just selling the discovery tools) because raw scientific understanding is often subsidized and harder to profit from directly than consumer products.
*   **Weather:** There is a specific debate regarding the efficacy of AI in weather forecasting, with users noting DeepMind's GraphCast/GenCast are making significant progress, potentially surpassing traditional models used by agencies like the BOM (Bureau of Meteorology).

**Media: "Brain Rot" or Future Art?**
The critique of entertainment AI sparked a polarized debate:
*   **The Skeptics:** Critics view current generative media as fueling "engagement scams," propaganda, and consumerism—essentially a waste of compute and human attention on "brain rot."
*   **The Optimists:** Defenders argue that current iterations (like "cat videos") are technological stepping stones. They envision a future where AI allows individuals to generate cinema-quality masterpieces or meaningful art instantly.
*   **Education:** A middle-ground emerged around **education**. Users suggested that video generation tools could democratize high-quality instruction, allowing individual teachers to produce visualizations on par with big-budget productions like *Cosmos* or *3Blue1Brown* cheaply and quickly.

**AI in Warfare**
A darker sub-thread explores the application of AI in military contexts.
*   Some users argue that metadata-based targeting and drone strikes represent a "huge improvement" over the prior state of affairs (indiscriminate city bombing).
*   Others push back, suggesting AI creates a "digital fog of war," distancing the public from the reality of violence and potentially facilitating "manufactured consent" or automated state-sponsored terror.

**Demis Hassabis & Open Source**
Users discussed the motivations of DeepMind's Demis Hassabis. While some interpreted his release of scientific data as a noble prioritization of human betterment over open profits, others offered a cynical take: that he may be "optimizing for a Nobel Prize" or that releasing structure predictions is commercially safe because the real financial value is gatekept behind proprietary downstream applications (like drug development).
