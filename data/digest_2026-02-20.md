...
#### [Submission URL](https://twitter.com/peterjliu/status/2024901585806225723) | 96 points | by [somerandomness](https://news.ycombinator.com/user?id=somerandomness) | [81 comments](https://news.ycombinator.com/item?id=47091557)

I’m ready—please share the Hacker News submission or article link (or paste the text/attach a screenshot), and I’ll produce an engaging digest-style summary.

Optional: tell me your preference for length (e.g., 100–150 words or bullet points) and tone (straightforward or punchy).

Here is a summary of the discussion surrounding the speculation on Polymarket and insider trading:

**The Submission:**
The author questions whether Polymarket is implicitly designed to detect, monetize, and normalize insider trading. The post speculates that the platform may encourage users to create multiple accounts to obscure "whale" or insider activity, effectively turning inside information into a tradable commodity under the guise of market efficiency.

**The Discussion:**
The comments debate whether insider activity is a bug or the primary feature of prediction markets.

*   **Feature, not a Bug:** Several users argue that prediction markets are designed to be "truth machines." For the odds to be accurate, they must reflect *all* available information, including secrets. As one commenter noted, if the market doesn't reflect insider knowledge, it isn't efficient.
*   **The "Theft" Distinction:** Drawing on Matt Levine’s financial writings, the discussion distinguishes between unfair trading and the "theft" of proprietary information. Users compared this to commodities markets (like soybeans), where farmers essentially trade on "insider" knowledge of their own harvest primarily for hedging, which is legal and helpful for price discovery.
*   **Gambling vs. Signal:** Sceptics argue that without insiders, the platform is merely a gambling venue for addicts playing negative-EV games. Proponents counter that the "smart money" (insiders) creates the liquidity and accuracy that makes the market useful as an insurance or hedging tool for everyone else.
*   **Hiding Tracks:** Addressing the OP's point on multiple accounts, commenters agreed that smart insiders naturally stick to small, distributed bets to avoid moving the price against themselves too quickly, making detection difficult regardless of platform enforcement.
