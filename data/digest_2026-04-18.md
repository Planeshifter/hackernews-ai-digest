...
### **Hacker News Daily Digest: The Analog Resistance to AI**

**The Catalyst:** A Cornell German instructor has made headlines for forcing students to write essays on thrifted manual typewriters. With screens, delete keys, and spellcheck completely removed, the analog approach is meant to combat AI-generated perfection, cut down on distractions, and refocus students on the raw process of writing. 
...
### **Opus 4.7 vs 4.6: Cheaper Tokens, but at What Cost to Quality?**

A new crowdsourced web app by Community Averages recently sparked a deep debate on Hacker News about the real-world performance differences between Anthropic’s Claude Opus models. While the tool was built to track token usage and cost differences between Opus 4.6 and 4.7, the conversation quickly pivoted from budgets to a broader critique of Opus 4.7's reasoning capabilities. 
...
HN Top Story: Figma’s “source of truth” era is ending; code-native design (à la Claude Design) will win
...
**Topic:** Figma’s “source of truth” era is ending; code-native design (à la Claude Design) will win.
