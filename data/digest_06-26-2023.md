...
A new prototype AI tool called Kor was submitted on Hacker News that helps in extracting structured data from text using LLMs. Users can specify the schema of what should be extracted and provide examples, and then Kor generates a prompt and sends it to the specified LLMs. The tool then parses the output and provides the result back to the user. The tool is integrated with LangChain framework but is still in its half-baked prototype stage with an unstable API. In the comments, users discussed the flexibility of running models in different languages, and its helpfulness in extracting metadata using LLMs. Some users also shared their thoughts on using LLMs to generate web scrapers efficiently, while others shared alternative models for extracting structured data from text. Furthermore, users discussed their experience using Kor in extracting data, and some suggested using CSS selectors in HTML documents for extracting data.
...
#### [Submission URL](https://fortune.com/2023/06/25/irl-shutting-down-startup-admits-95-percent-of-messaging-app-users-were-fake/) | 184 points | by [zanek](https://news.ycombinator.com/user?id=zanek) | [135 comments](https://news.ycombinator.com/item?id=36475376)

Messaging app startup IRL, which had raised $200 million from SoftBank and other investors, is shutting down after it was revealed that 95% of its users were fake or automated. Once valued at $1.2 billion, the company faced an SEC investigation into whether it breached securities laws by portraying its business performance inaccurately to investors. IRL counted Founders Fund, Goodyear Capital, and Floodgate Fund among its investors, with CEO Abraham Shafi at one point claiming the app had attracted 20 million monthly users. The SEC investigation continues.

IRL, a messaging app startup backed by SoftBank and other investors, is shutting down after it was revealed that 95% of its users were fake or automated. The company faced an SEC investigation into whether it breached securities laws by portraying its business performance inaccurately to investors. The discussion on Hacker News covers topics such as the importance of technical due diligence, the lack of trust in the startup world, and the role of VCs in investing. One user highlights the different forms of social proof and trust that investors rely on, while another user suggests that the SoftBank strategy of deploying capital quickly may not be effective in the long run.
...
Databricks has acquired MosaicML, a generative AI startup, for $1.3 billion. The acquisition is expected to address the growing demand from businesses to build their own language models. Some users on Hacker News were critical of the acquisition, stating that some companies do not have the technical talent to implement LLMs and that this could result in less meaningful value propositions. Others noted that Databricks is a technically-staffed company and that LLM integration would be a perfect fit for its business plan. Additionally, some users discussed the differences between Databricks and Snowflake in terms of data storage and management. Some users were not convinced of the value proposition of LLMs, stating that data warehouses are essentially required for these models. Lastly, some users pointed out that Databricks has replaced its self-managed Spark-on-K8s with third-party recommendations. A few users mentioned AWS SageMaker as a potential competitor to MosaicML.

### Reddit makes it impossible to delete PII, refuses to do it itself violating GDPR [video]

#### [Submission URL](https://www.youtube.com/watch?v=1B0GGsDdyHI) | 187 points | by [c2h5oh](https://news.ycombinator.com/user?id=c2h5oh) | [83 comments](https://news.ycombinator.com/item?id=36482168)

I'm sorry, but that text doesn't seem to be a story or submission from Hacker News. Could you please provide a valid Hacker News submission link or a news article for me to summarize?

This discussion on Hacker News covers a variety of topics related to Reddit, including the deletion and restoration of user comments, GDPR compliance and personal data protection, Reddit's handling of deleted content, and potential alternatives to the platform. Some users express frustration with Reddit's management and their response to user requests, while others suggest that competitors and specialized forums may be more effective in addressing these issues. The conversation also touches on the idea of a protest or boycott of Reddit, with some users skeptical of the potential impact.
