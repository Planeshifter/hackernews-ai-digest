...
Title: There is an AI Code Review Bubble (Greptile)
...
#### [Submission URL](https://www.msn.com/en-us/news/technology/i-let-chatgpt-analyze-a-decade-of-my-apple-watch-data-then-i-called-my-doctor/ar-AA1UZxip) | 191 points | by [zdw](https://news.ycombinator.com/user?id=zdw) | [189 comments](https://news.ycombinator.com/item?id=46772495)

I’m ready to summarize, but I don’t have the submission yet. Please share one of the following:
- The Hacker News item link (news.ycombinator.com/item?id=XXXXX)
- The article URL
- The article text pasted here (and any HN comment highlights if you want those reflected)

Optional: tell me your preferred length (quick blurb vs. 5–7 bullet digest) and tone (neutral, punchy, or technical).

Based on the comments provided, the discussion appears to center on an article involving **LLMs analyzing health metrics** (possibly turning them into a single "health score") and the broader reliability of health data.

Here is a summary of the discussion:

**Metrics vs. Context**
*   Commenters argue that raw health metrics (HRV, VO2 max, BMI) are misleading without proper context. An LLM trained on fitness forums might give a "bad score" to a person a doctor would consider perfectly healthy, simply because the medical standard for "health" (absence of risk factors) differs from the fitness community’s standard for "optimization."
*   There is skepticism about reducing complex biology to a single score. Many users feel that LLMs blindly respond to prompt requests rather than pushing back on the validity of the premise or asking for necessary variables.

**The BMI & Muscle Debate**
*   A significant portion of the thread focuses on the limitations of BMI. While users acknowledge it works for population-level statistics, they argue it fails at the individual level, specifically for muscular people.
*   One user shared an anecdote about being classified as "morbidly obese" by a GP despite a DEXA scan showing reasonable body fat percentages. The consensus is that many doctors prioritize clicking the "standard of care" checkboxes over interpreting nuanced data.

**Kidney Function & False Positives**
*   The discussion dives into technical specifics regarding kidney function tests (eGFR and creatinine).
*   Users note that standard kidney tests rely on creatinine levels, which are byproducts of muscle metabolism. Consequently, individuals with high muscle mass or those taking creatine supplements often trigger false alarms for kidney disease because the standard formulas assume average muscle mass. Use of Cystatin C testing was suggested as a more accurate alternative for this demographic.

**Instrumentation & Coaching**
*   Observations were made that metrics (like VO2 max) often become targets in themselves ("chasing the metric") rather than indicators of actual performance or health.
*   Users noted that accurate coaching requires knowing which metrics matter for a specific goal, whereas "instrumentation" just provides raw data that can be confused for medical insight.
...
Porting 100k lines from TypeScript to Rust in a month—using Claude Code
...
AI code and software craft (Jan 25, 2026)
...
Georgia moves to pause new datacenters as AI power demand spurs backlash
...
Slate’s Ask a Manager: How AI Is Quietly Wrecking Office Workflows
