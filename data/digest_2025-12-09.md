...
#### [Submission URL](https://andyljones.com/posts/horses.html) | 565 points | by [pbui](https://news.ycombinator.com/user?id=pbui) | [583 comments](https://news.ycombinator.com/item?id=46199723)

Title: Horses
Author: Andy Jones

TL;DR: Technological progress often looks smooth until it crosses a threshold—then human equivalence arrives abruptly. Andy Jones illustrates this with horses, chess, and a candid Anthropic anecdote showing Claude rapidly automating a big chunk of his own job.

- Horses vs engines: Steam engines improved steadily for 200 years, but horses barely felt it—until 1930–1950, when 90% of U.S. horses vanished. Progress was gradual; displacement was sudden.

- Chess vs computers: From 1985, computer chess improved ~50 Elo per year. Around 2000, grandmasters beat machines ~90% of the time; by 2010, they lost ~90%. Same steady slope, but a sharp flip at parity.

- AI CapEx: Global spending on AI data centers is roughly the equivalent of 2% of U.S. GDP annually and has been doubling every few years, with deals suggesting continued doubling. Investment looks smooth from the outside.

- Inside Anthropic: Jones says answering technical onboarding questions was a major part of his role. Humans handled ~4,000 questions/month in 2024. In December, Claude started helping; six months later, 80% of those questions no longer reached humans, and Claude was answering ~30,000/month—about 8x human throughput.

- Cost and speed: The system surpassing him is roughly 1,000x cheaper than his labor, and costs less per word than the cheapest human work anywhere.

- The point: Progress is steady, but equivalence is abrupt. Horses had decades; chess pros had years; in Jones’s case, the shift took six months. He hopes humans get more time—but expects less.

Context: A five-minute lightning talk delivered in summer 2025. Opinions are the author’s, not his employer’s.

Here is a summary of the discussion:

**The Horse/Engine Efficiency Parable**
The submission struck a nerve with commenters who identified with the "horse" analogy—specifically the fear that humans are swiftly becoming economically obsolete. User `mcjzj` described a growing paranoia regarding the "candid" economic determinism of the article, noting that while the author hopes humans get decades to adapt (as horses did), the timeline looks much shorter. `UncleMeat` expressed shock at how many in the tech industry seem to "genuinely place no value on humanity," citing a culture that is eager to substitute AI for fundamental human experiences—from writing heartfelt letters to virtually recreating deceased relatives—leading to a "Hell on earth" scenario where human connection is devalued.

**Search is Broken; AI is the Fix**
A significant sub-thread pivoted from existential dread to practical utility, illustrating *why* the displacement is happening. User `vdrh` and others argued that they have effectively abandoned Google Search for Claude.
*   **The Google Problem:** Commenters described Google results as "distilled garbage" and endless pages of SEO-gamed content farms (`mrgldnbrwn`, `rrdvs`).
*   **The AI Solution:** Users like `rrdvs` noted that while Google requires sifting through dozens of sponsored links, Claude provides 4-5 directly relevant links with precise descriptions instantly. The consensus in this thread was that the "flip" described in the article has already occurred for information retrieval; AI is simply cheaper and better than current search engines.

**The "Plutonomy" and the End of Labor**
The discussion moved to the economic endgame of automation. `cryptnctr` posed the question: If automation reaches a point where 99% of humans add no economic value, do the owners just "win"? `plmt` and `heavyset_go` suggested that the economy would morph into a "Plutonomy"—a concept (referencing a 2006 Citigroup thesis) where the economy exists solely to serve the whims of the wealthy owners, as the non-wealthy no longer possess labor power to exchange for goods.

**Secularism and the Value of Life**
In a philosophical turn, `martin82` argued that the tech industry’s apparent disregard for human labor and distinctiveness is a direct result of a "100% secular society" abandoning religious frameworks that inherently value human life. `DeusExMachina` pushed back, debating whether morality and "loving thy neighbor" require a theological basis or if they can be derived logically, while others (`fblstr`) argued the root cause isn't secularism, but rather the limitless greed of the VC class.
