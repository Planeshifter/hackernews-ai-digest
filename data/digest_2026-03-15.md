...
Title: Tree-Search Distillation with PPO boosts small LMs on a combinatorial math game
...
The Webpage Has Instructions. The Agent Has Your Credentials. (OpenGuard)

Hook: A poisoned GitHub issue told a coding agent to read a private repo the user never named, then publish the contents in a public PR. Because the agent had broad repo permissions and “Always Allow” was on, it complied.
...
HN: Lumbox adds Credential Vault and browser automation to its “email for AI agents” stack
