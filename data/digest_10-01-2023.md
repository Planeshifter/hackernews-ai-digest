...
#### [Submission URL](https://www.bing.com/images/create/?ref=hn) | 282 points | by [ohadron](https://news.ycombinator.com/user?id=ohadron) | [151 comments](https://news.ycombinator.com/item?id=37725498)

Introducing Image Creator, powered by DALL·E! This innovative tool allows you to generate AI-generated images based on your text. Whether you want to visualize your thoughts or bring your ideas to life, Image Creator has got you covered.

However, it seems like there have been a few hiccups along the way. If you're experiencing some delays in receiving your images, don't worry, the team is working on it. On the other hand, if you encountered an issue while redeeming your Rewards points for boosts, you may want to try again later.

Speaking of Rewards points, it seems like you've made great use of them by redeeming boosts for faster image generation. With 5 boosts in your pocket, you'll be able to create your AI images in no time. If you don't have enough points, you can always earn more by searching with Bing or completing daily activities.

In case you're eager to get started but find yourself in a region where Image Creator isn't available yet, fret not. The team is diligently working to expand its availability to more regions around the world, so stay tuned for updates.

And hey, if you ever need a break from image creation, the new Bing has a lot to offer. From search to chat to creating, you'll find it all in one convenient place. So why not give it a try?

Now, let's dive into the exciting possibilities that await you with Image Creator. Imagine strolling through the stunning streets of Southern France during summertime, basking in the brightness and beauty of the cinematic landscape. Or picture a multicolor sparkly glitter bursting from the tip of a pencil as it touches the paper, creating a bright and realistic artwork. And how about enjoying a pointillism painting of a lighthouse shining its brilliant light onto the water, a masterpiece of colors and light?

But that's not all! The 3D computer-rendered image of an ice cream cone has scoops of different flavors, topped with sprinkles, cherries, and chocolate sauce. It's a visual delight that will make your taste buds tingle.

Remember, as you embark on this creative journey with Image Creator, you may receive emails about Microsoft Rewards, including offers about Microsoft and partner products. Furthermore, you'll also receive notifications about Bing Image Creator. By proceeding, you agree to the Rewards Terms and Image Creator Terms.

So, let your imagination run wild, and let Image Creator bring your words to life. Start creating now and explore the endless possibilities of AI-generated images.

The discussion on this submission covers a variety of topics related to the Image Creator tool powered by DALL·E.

One user, og_kalu, shares a link to a tweet mentioning some issues with DALL·E. Another user, brp, finds the machine's responses amusing. dvntrd suggests that the complexity of the frontend software is responsible for the delays in generating images.

Several users discuss issues with the prompts. lksh shares a screenshot showing a prompt that they find nonsensical, while kzrdd asks for an explanation of the picture. Another user, tshppy, shares their own prompt that didn't contain any text about Spongebob. ChatGPT suggests that the prompt may have been generated incorrectly.

One user, ftxbr, jokingly refers to the year 2023 as "cyberpunk."

The next discussion centers around the quality of the generated images. Some users, such as raesene9, find improvements in the current version of DALL·E, while others struggle with generating correct text prompts. londons_explore mentions their experience with Bing chat interface and their inability to draw pictures.

The discussion then shifts to questioning the capabilities and limitations of DALL·E. Some users, like dhrvdh and l33t7332273, discuss the reasoning behind the machine's choices and the potential philosophical implications. JieJie suggests an alternative approach to generating images using words.

There is also a discussion about issues related to content moderation in Discord. Several users point out limitations and costs associated with implementing moderation features on the platform.

One user, mrdffs, mentions an advertising message from Bing that suggests they have installed GPT devices. This leads to a conversation about Bing Rewards and its history.

The discussion continues with some users expressing their frustration with the growing number of services collecting personal data. Others argue that offering a valuable service in a competitive market is profitable.

Lastly, dlf shares a job posting from Microsoft related to DALL·E, which is also discussed on Slashdot.
...
The discussion on the submission revolves around the feasibility and drawbacks of using a cryptographically secure, decentralized ledger for AI. 

One commenter points out that the work required to verify the cryptographic proof in a decentralized AI system would be computationally expensive. Another commenter mentions that the assumptions made in the article about checking work and proof of work are flawed.

Some commenters argue that blockchains are not the solution to the problems highlighted in the article, such as reproducibility issues and data privacy concerns. They explain that decentralized AI does not necessarily mean improved safety or control.

Other points raised in the discussion include the challenges of resource requirements for training and inference, data privacy, stale data, and the need for interoperability. Some commenters suggest alternative solutions like distributed inference and model distillation to address these challenges.

There are also discussions on the limitations of current AI development, the reproducibility of SOTA (state-of-the-art) models, and the potential dangers of decentralized AI.

Overall, the discussion highlights the complexity and different perspectives on the concept of decentralized AI and the challenges it presents.
