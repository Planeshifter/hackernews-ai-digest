...
### There's Waldo is a robot that finds Waldo (2018) [video]

#### [Submission URL](https://www.youtube.com/watch?v=-i7HMPpxB-Y) | 40 points | by [downboots](https://news.ycombinator.com/user?id=downboots) | [19 comments](https://news.ycombinator.com/item?id=38869961)

Introducing the Hacker News Daily Digest powered by OpenAI! Get ready to stay up-to-date with the latest tech news and highlights from Hacker News.

1. "GitHub Copilot: Your AI pair programmer" - GitHub has just launched a groundbreaking tool called Copilot that will revolutionize coding. Imagine having an AI as your coding partner, helping you write lines of code with ease. Copilot uses OpenAI's Codex to suggest code snippets and speed up your development workflow.

2. "SpaceX launching Starship Mark 1 Prototype" - Prepare for liftoff! SpaceX is gearing up to launch its Starship Mark 1 prototype, a giant rocket that could change the face of space travel. With its cutting-edge design and powerful engines, Starship aims to transport humans and cargo to the Moon, Mars, and beyond.

3. "Tesla announces breakthrough in battery technology" - Elon Musk's Tesla has achieved a major breakthrough in battery technology. Musk claims that their new batteries will significantly increase the range and efficiency of electric vehicles. This innovation could push the boundaries of EVs and bring us one step closer to a sustainable future.

4. "OpenAI announces GPT-4, the next generation of language model" - OpenAI recently announced the upcoming release of GPT-4, an even more advanced language model. GPT-3 already impressed us with its language generation capabilities, but GPT-4 promises to take it to a whole new level. Get ready for smarter conversations and more sophisticated AI-generated content.

5. "Google unveils quantum supremacy milestone" - Google has achieved a significant milestone in quantum computing: quantum supremacy. Their quantum computer is now capable of solving complex problems that traditional computers simply can't handle. Quantum computing could revolutionize fields like cryptography and optimization, paving the way for unprecedented advancements.

Stay tuned for tomorrow's digest, where we'll bring you more exciting news from the world of tech. Don't miss out on the latest trends and developments on Hacker News!

The discussion on this submission focuses on finding Waldo, the character from the "Where's Waldo?" books, using various methods and techniques. Some users share different approaches they have tried, such as using computer vision techniques, scanning machines, robotic arms, and vacuum prism scanners. They discuss the challenges and benefits of each method and express their fascination with the process.

One user mentions that human-powered training programs for finding Waldo are failing in the market, which sparks a conversation about the frustrations of searching for Waldo and the possibility of learning geography to find him more easily. Another user finds the discussion amusing and notes the difficulty of training pages for robots. 

There is also a brief mention of rubber hands for robots and a comment about scaling the Where's Waldo scenes for robot work. One user suggests that the robots should not give up on digging jobs as they generate great entertainment. 

Towards the end of the discussion, a user jokes about an AI that hides Waldo and another AI that finds him, highlighting the potential profitability of such a project. The discussion concludes with one user expressing their regret for missing a great opportunity.
