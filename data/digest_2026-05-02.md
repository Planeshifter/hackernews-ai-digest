...
### **Top Story: California to Ticket Driverless Car Companies for Moving Violations**

**The News:** 
Starting July 1, California will close a bizarre legal loophole that previously left police officers unable to ticket autonomous vehicles (AVs). Under new DMV regulations, cops will now be able to issue a “notice of AV noncompliance” directly to the manufacturers—such as Waymo and Tesla—when a robotaxi commits a moving violation. 

The most comprehensive AV regulations in the nation, these rules were sparked by ongoing frustrations with driverless cars blocking intersections, impeding first responders, and making illegal maneuvers. Additionally, AV operators will now be required to answer emergency calls within 30 seconds and will face strict penalties if their cars enter active emergency scenes. The move formalizes corporate accountability, pressures operators to improve remote assistance, and establishes a blueprint other states will likely follow.
